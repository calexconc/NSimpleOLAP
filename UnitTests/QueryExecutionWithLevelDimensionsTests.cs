...
{
  [TestFixture]
  public class QueryExecutionWithLevelDimensionsTests
  {
    private Cube<int> cube;

    public QueryExecutionWithLevelDimensionsTests()
    {
      Init();
    }
    ...
    [Test]
    public void Simple_Query_Month_Country_On_Measure_Quantity()
    {
      var queryBuilder = cube.BuildQuery()
        .OnRows("Month.All")
        .OnColumns("Country.All")
        .AddMeasuresOrMetrics("quantity");

      var query = queryBuilder.Create();
      var result = query.StreamRows().ToList();

      Assert.IsTrue(result[0].Length == 6);
    ...
    [Test]
    public void Simple_Query_Region_Extra_All_On_Measure_Quantity()
    {
      var queryBuilder = cube.BuildQuery()
        .OnRows("Region.All")
    ...
    [Test]
    public void Simple_Query_Region_Extra_All_On_Reverse_Measure_Quantity()
    {
      var queryBuilder = cube.BuildQuery()
        .OnRows("Region.All")
    ...
    [Test]
    public void Simple_Query_Month_Region_Country_Extra_All_Measure_Quantity()
    {
      var queryBuilder = cube.BuildQuery()
        .OnRows("Region.All.Country.All")
