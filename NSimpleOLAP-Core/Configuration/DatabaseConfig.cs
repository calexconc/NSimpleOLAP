...
{
  public sealed class DatabaseConfig : AbstractConfigCollection<ConnectionSettings>
  {
    public DatabaseConfig()
    {
      indexer = new Dictionary<string, int>();
      elements = new List<ConnectionSettings>();
    }
    ...
    public override void Add(ConnectionSettings element)
    {
    ...
    public override bool Remove(ConnectionSettings item)
    {
