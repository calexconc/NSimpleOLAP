...
namespace NSimpleOLAP.Configuration
{
  ...
  /// </summary>
  public sealed class FieldConfigCollection : IConfigCollection<FieldConfig>
  {
    #region Properties
    ...
    public bool Contains(FieldConfig item)
    {
      throw new System.NotImplementedException();
    }

    public void CopyTo(FieldConfig[] array, int arrayIndex)
    {
      throw new System.NotImplementedException();
    }

    public IEnumerator<FieldConfig> GetEnumerator()
    {
      throw new System.NotImplementedException();
    }
    ...
    public bool Remove(FieldConfig item)
    {
      throw new System.NotImplementedException();
    }
