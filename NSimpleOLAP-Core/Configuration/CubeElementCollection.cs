...
namespace NSimpleOLAP.Configuration
{
  ...
  /// </summary>
  public sealed class CubeConfigCollection : AbstractConfigCollection<CubeConfig>
  {
    public CubeConfigCollection()
    {
      indexer = new Dictionary<string, int>();
      elements = new List<CubeConfig>();
    }
    ...
    public override void Add(CubeConfig element)
    {
    ...
    public override bool Remove(CubeConfig item)
    {
